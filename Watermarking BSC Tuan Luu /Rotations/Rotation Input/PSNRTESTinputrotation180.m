...
originalImage = imread('input.jpeg'); % Ersetzen Sie 'original.png' durch den Dateinamen Ihres Originalbildes
compressedImage = imread('rotation_bild180real2input.png'); % Ersetzen Sie 'compressed.png' durch den Dateinamen Ihres komprimierten/veränderten Bildes
...
% Höhe und Breite der Bilder ermitteln-> Als Einschub bitte noch für alle
% anderen PSNR Test einfügen
