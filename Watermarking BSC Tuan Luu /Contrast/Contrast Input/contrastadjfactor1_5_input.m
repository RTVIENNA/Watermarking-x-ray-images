...
contrastFactor = 1.5; % Zum Beispiel, um den Kontrast zu erhöhen
...
imwrite(adjustedImage, 'contrastadjfactor1_5_input.jpg'); % Ersetzen Sie 'adjusted_image.jpg' durch den gewünschten Dateinamen
