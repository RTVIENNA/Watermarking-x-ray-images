...
compressedImage = imread('contrastadjfactor1_5_input.jpg'); % Ersetzen Sie 'compressed.png' durch den Dateinamen Ihres komprimierten/veränderten Bildes
...
% PSNR-Wert anzeigen
fprintf('PSNR: %.2f dB\n', psnr);
%PSNRTESTcontrastadjfactor1_5_input
