...
compressedImage = imread('contrastadjfactor0_8_input.jpg'); % Ersetzen Sie 'compressed.png' durch den Dateinamen Ihres komprimierten/veränderten Bildes
...
% PSNR-Wert anzeigen
fprintf('PSNR: %.2f dB\n', psnr);
%PSNRTESTcontrastadjfactor0_8_input
