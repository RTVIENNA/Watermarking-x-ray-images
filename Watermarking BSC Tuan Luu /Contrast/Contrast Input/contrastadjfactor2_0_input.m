...
contrastFactor = 2.0; % Zum Beispiel, um den Kontrast zu erhöhen
...
imwrite(adjustedImage, 'contrastadjfactor2_0_input.jpg'); % Ersetzen Sie 'adjusted_image.jpg' durch den gewünschten Dateinamen
